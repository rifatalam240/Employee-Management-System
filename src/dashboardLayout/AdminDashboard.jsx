...
const AdminDashboard = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 dark:bg-gray-900">
      <h2 className="text-3xl font-semibold mb-6 text-center dark:text-gray-300 text-gray-800">👤 All Users (Admin Panel)</h2>
                ...
                <tr key={user._id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                  ...
                  <td className="px-4 py-3 text-center">
                    <select
                      ...
                      className="border border-gray-300 dark:bg-gray-900 rounded px-2 py-1"
                    >
